  ...
  <div class="cont-top-box">
    <el-form label-width="100px">
      <el-form-item label="站点:">
        <el-checkbox-group v-model="stationChecks" style="display:inline-block">
          <el-checkbox v-for="item in stationList" :key="item" :label="item" @change="checkChange">{{ item}}</el-checkbox>
        </el-checkbox-group>
      </el-form-item>
      <el-form-item label="完成状态:">
        <el-checkbox-group v-model="taskChecks" style="display:inline-block">
          <el-checkbox v-for="item in taskList" :key="item" :label="item" @change="checkChange">{{ item}}</el-checkbox>
        </el-checkbox-group>
      </el-form-item>
      ...
      <el-form-item label="操作:">
        <el-button size="mini" type="primary" @click="" icon="el-icon-search">查找</el-button>
        <el-button size="mini" type="warning" @click="" icon="el-icon-brush">清除</el-button>
...
export default {
  ...
  data() {
    return {
      tips: {},
      keyword: '',
      stationList: ['1号堆垛机','1号提升机','2号堆垛机','2号提升机','3号堆垛机',],
      taskList:['已完成','未完成'],
      departmentChecks: [],
      stationChecks:[],
      taskChecks:[],
